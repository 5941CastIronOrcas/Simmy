...
public class ArmSubsystem extends SubsystemBase {
  ...
  public void resetArmAngles(){
    Constants.armMotor1.getEncoder().setPosition((Constants.armCalibrateAngle1 / Constants.armGearRatio1) / 360);
    Constants.armMotor2.getEncoder().setPosition((Constants.armCalibrateAngle2 / Constants.armGearRatio2) / 360);
  }
